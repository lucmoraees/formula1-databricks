...
# MAGIC %md
# MAGIC ##### Step 1 - Read the JSON file using the spark datafrae reader API
...
# results_deduped_df.write.mode("append").partitionBy("race_id").format("parquet").saveAsTable("f1_processed.results")
...
# overwrite_partition(results_deduped_df, 'f1_processed', 'results', 'race_id')
